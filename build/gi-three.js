...
System.register("examples/GIJSView", ["examples/GIRenderBase", "src/engine/data/OBJLoader", "src/engine/scene/materials/SpecularMaterial", "src/engine/math/Color", "src/engine/scene/Camera", "src/engine/scene/SharedScene", "src/engine/scene/shapes/Cube", "src/engine/math/Vector3", "src/engine/scene/materials/DiffuseMaterial", "src/engine/scene/shapes/Sphere", "src/engine/scene/materials/LightMaterial", "src/engine/scene/materials/Attenuation"], function(exports_55, context_55) {
    "use strict";
    var __moduleName = context_55 && context_55.id;
    var GIRenderBase_1, OBJLoader_1, SpecularMaterial_2, Color_11, Camera_2, SharedScene_2, Cube_3, Vector3_12, DiffuseMaterial_2, Sphere_3, LightMaterial_2, Attenuation_8;
    var GIJSView;
    return {
        setters:[
        ...
        execute: function() {
            GIJSView = (function (_super) {
                ...
                function GIJSView(width, height, container) {
                    ...
                    this.scene.add(Cube_3.Cube.newCube(new Vector3_12.Vector3(-100, -1, -100), new Vector3_12.Vector3(100, 0, 100), new DiffuseMaterial_2.DiffuseMaterial(new Color_11.Color(1, 1, 1))));
                ...
                GIJSView.prototype.setThreeJSScene = function (scene) {
                    console.log(scene);
                };
            ...
            exports_55("GIJSView", GIJSView);
        }
    }
});
System.register("examples/Example1", ["examples/GUI", "examples/GIJSView", "examples/ThreeJSView", "src/engine/utils/MathUtils"], function(exports_56, context_56) {
    "use strict";
        ...
        execute: function() {
            Example1 = (function (_super) {
                ...
                Example1.prototype.onInit = function () {
                    ...
                    this.giJSView.loadModel('../models/sponza.obj', function () {
            ...
            exports_56("Example1", Example1);
        }
    }
});
System.register("src/engine/renderer/LiteBucketRenderer", ["src/engine/renderer/worker/TraceJobManager", "src/engine/renderer/worker/TraceJob"], function(exports_57, context_57) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            exports_57("LiteBucketRenderer", LiteBucketRenderer);
        }
    }
});
System.register("src/engine/scene/materials/TransparentMaterial", ["src/engine/scene/materials/Material", "src/engine/scene/materials/Attenuation"], function(exports_58, context_58) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            exports_58("TransparentMaterial", TransparentMaterial);
        }
    }
});
System.register("src/three/GIThree", [], function(exports_59, context_59) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            exports_59("GIThree", GIThree);
        }
    }
});
System.register("src/utils/NetworkUtils", [], function(exports_60, context_60) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            exports_60("NetworkUtils", NetworkUtils);
        }
    }
});
